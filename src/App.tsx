        ...
        <div className={style.Main} id={"App"}>
            <div className={style.Up}>
                ...
                <div className={style.Slk}>
                    ...
                    <a onMouseOver={() => { setShowMyOpis([false, true, false, false]) }} onMouseOut={() => { setShowMyOpis([false, false, false, false]) }} target="_blank" href="https://github.com/HidasMato/role_cards_spells"><GH className={style.Icon2} /></a>
